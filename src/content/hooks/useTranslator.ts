...
import { checkTranslatorAvailability, createTranslator } from '../../utils/geminiApi';

export const useTranslator = () => {
  const [availability, setAvailability] = useState<TranslationAvailability>('unavailable');
